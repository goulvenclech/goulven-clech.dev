...
export default defineConfig({
	...
	env: {
		schema: {
			...
			MAPS_TOKEN: envField.string({ context: "server", access: "secret" }),
			GITHUB_TOKEN: envField.string({ context: "server", access: "secret" }),
			TURSO_TOKEN: envField.string({ context: "server", access: "secret" }),
			TURSO_URL: envField.string({ context: "server", access: "public" }),
			CATALOGUE_PASSWORD: envField.string({
				context: "server",
				access: "secret",
			}),
			BODY_SYNC_SECRET: envField.string({
				context: "server",
				access: "secret",
			}),
			IGDB_ID: envField.string({ context: "server", access: "secret" }),
			IGDB_SECRET: envField.string({ context: "server", access: "secret" }),
