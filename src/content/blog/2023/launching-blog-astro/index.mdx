...
Firstly, a <LinkInline to="https://en.wikipedia.org/wiki/Static_web_page">static website</LinkInline> consists of web pages delivered to the browser exactly as they are stored, unlike a <LinkInline to="https://en.wikipedia.org/wiki/Dynamic_web_page">dynamic website</LinkInline> where a server will generate the pages at every user request.
