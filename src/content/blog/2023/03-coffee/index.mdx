...
slug: "2023-discovering-coffee-in-toulouse"
date: 2023-03-15
...
image_caption: "Temporary cover, borrowed from le Café Cerise"
abstract: "Let's talk about my first steps in the world of coffee, some recommendations on books and set-ups, and my favourite addresses in Toulouse."
---
...
I've always drank coffee, probably like you, without great pleasure nor understanding much about it.

I thought the "good" coffee was dark, bitter, intense coffees that our fathers drank grimacing... So understand my surprise when I first heard an expert talk about coffee:

<YoutubeBlock id="Z-iNAyu-ejo" />

In October 2021, the <LinkInline to="https://www.youtube.com/channel/UCBa659QWEk1AI4Tg--mrJ2A">videomaker Tom Scott</LinkInline> explained that he didn't like coffee as a kid and wanted to re-evaluate his judgement. He invited James Hoffmann, a world-champion barista and a coffee YouTuber, to re-introduce him to coffee.
...
After the video with Tom, I devoured <LinkInline to="https://www.youtube.com/@jameshoffmann">James Hoffman's Youtube channel</LinkInline> and those of <LinkInline to="https://www.youtube.com/@EuropeanCoffeeTrip">European Coffee Trip</LinkInline> and <LinkInline to="https://www.youtube.com/@morgandrinkscoffee">Morgan Eckroth</LinkInline>. They gave me a glimpse of how much richer and more complex coffee is than I thought.
...
He explained well why the coffee I knew tasted like wood, and dared to say that bitter and astringent flavours were not a sign of quality... But burnt beans. In fact, dark roasting is an excellent way for industrials to hide poor raw materials.

<YoutubeBlock id="liGwcuFyaNY" />

The second video comes from the <LinkInline to="https://www.youtube.com/@epicurious">Epicurious channel</LinkInline>, featuring Dillon Edwards. The expert will taste several pairs of coffee and successfully guess the most expensive ones every time. Proving that coffee has different qualities, clearly distinguishable in blind-tasting.
...
<FigImage
  ...
  caption="Temporary image, borrowed from Hayuco."
/>
...
Here I offer you the best scales for coffee: precise, well built, with timer, flow measurement, rechargeable... But honestly, the kitchen scale you already have is more than enough.
...
First, the Moka Pot. The most practical and affordable, hands down, way to make a good coffee.

No need for filters or recipes; place your coffee in the basket, fill the bottom with boiling water, and after a minute on medium heat, et voilà! A coffee that is strong in flavour, with a good body, low in caffeine, and that you can reliably reproduce every morning.
...
Also, you may want to invest in an electric kettle with a gooseneck for the best results. To be able to set the water's temperature precisely and to pour with precision.
...
Finally, to avoid buying new coffee makers, you can use your French press lying around at home.
...
To end with a little bonus, let me share some addresses in my city.

For a "small" town of ~500,000 souls, Toulouse surprisingly has a lot of lovely places around coffee. For this first article, let's focus on the four coffee roasters I've met and loved:

<MapsBlock id="ChIJSfDG2G-9rhIReM7UDLELHc4" />

At the entrance of the Tonsor & Cie barber, you'll meet Carlos, Karim, and Orianne from Hayuco. Incredibly welcoming and passionate, chat with them (and taste) their Bolivian coffees from the La Real Expedición Botánica cooperative. You can also try cascara, an infusion of coffee cherries.
...
Blabla chatting about Café Cerise.

<MapsBlock id="ChIJIe7lGuK7rhIRn33k9kSSnfQ" />

Blabla chatting about Perla Negra.
