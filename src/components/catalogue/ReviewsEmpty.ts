/**
 * A simple web component to display no results message
 */
export class ReviewsEmpty extends HTMLElement {
  constructor() {
    super()
    this.render()
    return this
...
customElements.define("reviews-empty", ReviewsEmpty)
